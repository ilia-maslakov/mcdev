...
gboolean runtime_host_editor_text (const mc_runtime_handle_t *handle,
                                   const mc_runtime_editor_range_t *range,
                                   gboolean has_revision, guint64 revision,
...
gboolean runtime_host_editor_edit (const mc_runtime_handle_t *handle,
                                   ...
                                   const char **error);
gboolean runtime_host_editor_replace_selection (
    const mc_runtime_handle_t *handle, const char *text, gsize text_length,

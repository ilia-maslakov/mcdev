...
/* --------------------------------------------------------------------------------------------- */
/**
 * Render a terminal canvas region onto the physical screen.
 * screen_y/screen_x are absolute tty coordinates of the top-left corner.
 * top_row is the first canvas row to display.
 * Exported so that WMcTerm can reuse the same render path.
 */
void

...
typedef enum
{
    ...
    MCTREE_PROVIDER_DISABLED,
    MCTREE_PROVIDER_MISSING
...
const mctree_provider_t *const *mctree_provider_list (gsize *count);
...
const char *mctree_provider_state_name (mctree_provider_state_t state);
